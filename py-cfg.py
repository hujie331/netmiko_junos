...
for device in devices:
    ...
    file_name = command_file + ' on ' + device_group + '.rst'
    with open(file_name, 'a') as out_file:
        ...
        try:
            ...
            for command in commands:
                ...
                print(connection.send_config_set(command, exit_config_mode=False))
                print(connection.send_config_set(command), file=out_file)
                ...
                print()
                print()
            print(connection.send_command('show configuration | compare'))
            print(connection.send_command('show configuration | compare'), file=out_file)
            print(connection.commit())
            print(connection.commit(), file=out_file)
...
os.system('mv *.rst cmd-set-cfg-result')
os.system('echo')
os.system('echo "   ************************************************************************"')
